        ...
        <div id="page-content-wrapper">
            ...
            <div class="warp-content container">
                ...
                <div class="position-list row">
                    <div class="col-sm-12">
                        <h2>Position list</h2>
                        <table id="position-table" class="table table-bordered  dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                            <thead>
                                <tr role="row">
