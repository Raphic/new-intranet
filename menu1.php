    ...
    <div id="sidebarleft">
       <div class="overlay"></div>
        ...
        <div id="sidebarleft-wrapper">
            <ul id="accordion" class="sidebarleft-nav">
                <li class="sidebarleft-brand"><a href="#">ILA Intranet</a></li>
                <li>
                    <a data-toggle="collapse" data-parent="#accordion" href="#sidebar-sub01">
                        Centres
                        <span class="caret"></span>
                    </a>
                    <ul id="sidebar-sub01" class="collapse list-unstyled in">
                        <li class="dropdown">
                        ...
                        <li class="dropdown"> 
                            <a href="#" data-toggle="dropdown">South <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
...
<!--                           <li><a href="#" title="">TC-HCMC19</a></li>-->
                ...
                <li>
                    <a data-toggle="collapse" data-parent="#accordion" href="#sidebar-sub02">
                        Departments
                        <span class="caret"></span>
                    </a>
                    <ul id="sidebar-sub02" class="collapse list-unstyled in">
      ...
      var trigger = $('.hamburger'),
        ...
        function overlay_x() {
              if (isClosed == true) {          
                ...
                $("#sidebarleft-wrapper").css("overflow-y", "auto");
              } else {   
                overlay.show();
                trigger.removeClass('is-closed');
                trigger.addClass('is-open');
          ...
          $("#sidebar-sub01").click(function(){
            $("#sidebarleft-wrapper").css("overflow-y", "inherit");
          });
    });
    </script>
